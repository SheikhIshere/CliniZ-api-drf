...
class DoctorAdmin(admin.ModelAdmin):
    list_display = ("id", "full_name", "fee", "year_of_experience", "is_verified", "verification_status", "personal_status")
...
class QualificationAdmin(admin.ModelAdmin):
    list_display = ("id", "doctor", "degree", "institution", "year", "verification_status", "registration_id")
